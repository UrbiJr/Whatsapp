...
A SPECIAL THANKS TO Beej and his "guide to Network Programming".
 ...
 * @param  domain   describes what kind of socket you're interested in
 *                  (PF_INET or PF_INET6)
 ...
 * @param  my_addr pointer to a struct sockaddr that contains information
 *                 about our address
 ...
 * @param  sockfd socket descriptor
 * @param  res    pointer to linked-list of the address to connect to
 *                (see Getaddrinfo())
 * @return        ERROR on error, 0 on success
 */
 ...
 * @param  sockfd  socket descriptor
 * @param  backlog how many pending connections you can have before the kernel
 ...
 * @param  sockfd  socket descriptor
 * @param  addr    This is filled in with the address of the site that's connecting
 *                 to you
 * @param  addrlen This is filled in with the sizeof() the structure returned in the
 *                 addr parameter
...
// see <http://stackoverflow.com/a/24260280/7158454>
...
// see <http://stackoverflow.com/a/20149925/7158454>
...
/**
 * just a primary check
 * @param  expected number of expected parameters
