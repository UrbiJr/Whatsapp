...
/*!	\fn define_language
	\brief fills all the strings with the strings of the selected language
	\param n selected language
	\return struct recCurrentLanguage
*/
recCurrentLanguage define_language(int n){
	...
	switch(n){
		...
		case 1:
			...
			strcpy(lang.s59, "Whatsapp 1.0.0");
			break;
		// ENG
		case 2:
